	...
	try {
		...
		if (reaction.partial) {
			try {
				...
				logger.error(error, { label: 'messageReactionAdd:fetchMessage' });
				return;
			}
		}
		if (user.partial) {
			try {
				...
				logger.error(error, { label: 'messageReactionAdd:fetchUser' });
				return;
			}
		}
		...
		logger.error(err, { label: 'messageReactionAdd' });
